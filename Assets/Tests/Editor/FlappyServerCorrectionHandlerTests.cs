...
namespace LOP.Tests
{
    public class FlappyServerCorrectionHandlerTests
    {
        ...
        public void 남은_틱만큼_초로_바뀐다()
        {
            ...
            Assert.AreEqual(0.2f, FlappyTickDuration.RemainingSeconds(
                endTick: 20, tick: 10, deltaTime: 0.02f), 1e-4f);
        }
        ...
        public void 종료틱과_지금틱이_같으면_0이다()
        {
            ...
            Assert.AreEqual(0f, FlappyTickDuration.RemainingSeconds(
                endTick: 10, tick: 10, deltaTime: 0.02f), 1e-4f);
        }
        ...
        public void 종료틱이_지금틱보다_과거면_음수_대신_0이다()
        {
            ...
            Assert.AreEqual(0f, FlappyTickDuration.RemainingSeconds(
                endTick: 5, tick: 10, deltaTime: 0.02f), 1e-4f);
        }
        ...
        public void 종료틱이_0이면_안_멈춘_것이라_0이다()
        {
            ...
            Assert.AreEqual(0f, FlappyTickDuration.RemainingSeconds(
                endTick: 0, tick: 10, deltaTime: 0.02f), 1e-4f);
        }
