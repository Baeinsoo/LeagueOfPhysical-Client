...
(191/191/190/187회 날갯짓), 넷 다 진짜 커널 재생에서 어긋났다. 원인은 측정됐다: 탐색이 매 틱
새 높이를 0.1m 눈금에 반올림하는데, 그 반올림이 틱마다 새 쪽으로 약 0.04m씩 유리하게 쏠리고,
다음 틱은 그렇게 부풀려진 높이에서 또 쌓인다 — 187~191번의 날갯짓에 걸쳐 누적하면 허공에 뜬
높이가 약 7m가 된다. 탐색이 찾은 경로는 진짜 물리에서 버티지 못한다.
