...
- [x] **Step 2: 서버 `LOPRunner`에 `EndMatch()` 추가 + `LateUpdate`가 호출하도록 교체**
...
- [x] **Step 3: `IMatchResultDataStore.cs`**
...
- [x] **Step 4: `MatchResultDataStore.cs`**
...
- [x] **Step 5: Root 스코프에 등록 + 메시지 브로커 등록**
...
- [x] **Step 1: 클라 `LOPRunner.EndMatch()` 추가**
...
- [x] **Step 2: `MatchEndedMessageHandler.cs`**
...
- [x] **Step 4: Game 스코프에 핸들러 등록 + 러너를 자기 타입으로도 resolve 가능하게**
...
- [x] **Step 4: Unity 임포트 + 카탈로그 엔트리 추가**
...
- [x] **Step 1: `FrontEndCoordinator.cs` 전체 교체**
...
- [x] **Step 2: `LobbyLifetimeScope.cs`에 결과 뷰 등록**
